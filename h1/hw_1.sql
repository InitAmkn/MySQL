...
SELECT product_name, manufacturer FROM mobile_phones
...
manufacturer LIKE "%Iphone%" or
product_count LIKE "%Iphone%" or
price LIKE "%Iphone%";

SELECT * FROM mobile_phones
WHERE product_name LIKE "%Samsung%" or
manufacturer LIKE "%Samsung%" or
product_count LIKE "%Samsung%" or
price LIKE "%Samsung%";
